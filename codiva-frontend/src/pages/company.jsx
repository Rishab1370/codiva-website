...
export default function Company() {
  ...
  <div className="relative flex overflow-x-hidden group">
      ...
      {[
        ...
        >
          <img
            src={tech.icon}
            alt={tech.name}
            className="w-20 object-contain transition-all duration-300 drop-shadow-[0_0_20px_rgba(0,255,255,0.3)]"
          />
    ...
    <div className="flex animate-marquee2 whitespace-nowrap group-hover:[animation-play-state:paused]">
      {[
        { name: "HTML5", icon: "/icons/html5.svg" },
        { name: "CSS3", icon: "/icons/css.svg" },
        { name: "JavaScript", icon: "/icons/javascript.svg" },
